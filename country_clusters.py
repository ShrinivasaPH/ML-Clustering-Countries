...
child_mort = col1.slider("Select the Child Mortality Rate:", 2.6, 208.000000)
exports = col2.slider("Select the Export value:", 0.1090, 200.000000)
health = col1.slider("Select the Health-Spending Rate:", 1.8100, 17.900000)
imports = col2.slider("Select the Import Rate:", 0.0659, 174.000000)
income = col1.slider("Select the Income value:", 609.0000, 125000.000000)
inflation = col2.slider("Select the Inflation Rate:", -4.2100, 104.000000)
life_expec = col1.slider("Select the Life Expectancy Rate:", 32.100000, 82.800000)
total_fer = col2.slider("Select the Fertility Rate:", 1.1500, 7.490000)
gdpp = col1.slider("Select GDPP Rate:", 231.000000, 105000.000000)
net_export_ratio = col2.slider("Select Net Export Ratio:", -0.224771, 0.011095)
